import { Box, Button, Flex, Img, Input, Stack, Text, VStack } from "@chakra-ui/react";
    ...
    <div>
      <Stack  >
        ...
        <Flex     justifyContent="space-between" >
          ...
          <Flex  width="17%" alignItems="center" justifyContent="space-between">
            <Img src="https://c4.staticflickr.com/8/7219/27203697011_373d85175d_b.jpg" borderRadius="full" width="30%" height="100%"/>
            <Text color="black" fontWeight="bold">Parker Walker</Text>
          </Flex>
        </Flex>
                </VStack>
                <Slidingimages/><br/><br/>
